...
namespace MetaboliteLevels.Forms.Startup
{
    ...
    internal partial class FrmActDataLoad : Form, IProgressReceiver
    {
        ...
        /// </summary>
        private static ConfigurationStatistic CreateTTestStatistic( IProvider<IntensityMatrix> src, GroupInfo typeOfInterestName, ObsFilter typeOfInterest, IEnumerable< GroupInfo> controlName, ObsFilter controlConditions)
        {
        ...
        /// </summary>
        private static ConfigurationStatistic CreatePearsonStatistic( IProvider<IntensityMatrix> src, GroupInfo typeOfInterestName, ObsFilter typeOfInterest)
        {
            ...
            argsPearson.OverrideDisplayName = "r."+ typeOfInterestName.DisplayShortName;
            argsPearson.Comment = $"Autogenerated statistic.\r\nPearson correlation of the trend-line for {{{typeOfInterestName.DisplayName}}} against time.";
