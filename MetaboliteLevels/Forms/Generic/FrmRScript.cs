...
namespace MetaboliteLevels.Forms.Generic
{
    internal partial class FrmRScript : Form
    {
        ...
        {
            using (FrmRScript frm = new FrmRScript(title, inputs, folder, fileName, workOnCopy, defaultContent, readOnly))
            {
        ...
        public FrmRScript(string title, string inputs, UiControls.EInitialFolder saveFolder, string fileName, bool workOnCopy, string defaultContent, bool readOnly)
            : this()
        {
        ...
        private void _btnOk_Click(object sender, EventArgs e)
        {
            ...
            {
                string text = FrmInput.Show(this, Text, "Save changes", "Please enter a name for your script", "");
