...
namespace MetaboliteLevels.Forms.Editing
{
    public partial class FrmEditFlag : Form
    {
        ...
        {
            UiControls.Assert(flag != null);

            using (FrmEditFlag frm = new FrmEditFlag(flag, readOnly))
            {
        ...
        public FrmEditFlag(PeakFlag flag, bool readOnly)
        {
            InitializeComponent();      
        ...
        {
            FrmInput2.Show(this, _txtName, ref _comment, _readOnly);
        }
    }
}
